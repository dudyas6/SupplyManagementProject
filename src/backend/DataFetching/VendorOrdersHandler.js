...
export async function GenerateNewOrder() {
  ...
  return axios
    .post(`https://supply-management-api.vercel.app/orders/vendor/add/`, order)
    .then((res) => {
      return res.data;
    })
    .catch((error) => {
...
export function GetAllOrders() {
  return axios
    .get(`https://supply-management-api.vercel.app/orders/vendor/get/`)
    .then((response) => {
...
export function AutoChangeAllVendorOrdersStatus() {
  return axios
    .get(`https://supply-management-api.vercel.app/orders/vendor/update-orders/`)
    .then((res) => {
      return res.data;
    })
    .catch((err) => {
...
export function GetCompletedAndNotAddedOrders() {
  ...
  return axios
    .get(`https://supply-management-api.vercel.app/orders/vendor/get-completed-orders/`)
    .then((res) => {
      return res.data;
    })
    .catch((err) => {
...
export function AddCompletedOrdersToWarehouse() {
  ...
  return axios
    .get(`https://supply-management-api.vercel.app/orders/vendor/completed-orders-change/`)
    .then((res) => {
      return res.data;
    })
    .catch((err) => {
