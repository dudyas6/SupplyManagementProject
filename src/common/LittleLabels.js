export function SuccessLabel({ innerText, onClose }) {
  return (
    <div
    className="bg-green-300 mb-2 border border-green-300 text-green-600 px-4 py-3 rounded relative"
      role="alert"
    >
      <strong className="font-bold">Success! </strong>
      <div className="sm:inline" style={{ whiteSpace: "pre-line" }}>
        {innerText}
      </div>{" "}
...
export function ErrorLabel({ innerText, onClose }) {
